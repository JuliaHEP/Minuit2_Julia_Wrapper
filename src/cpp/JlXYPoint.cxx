...
struct JlXYPoint: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.constructor<const XYPoint &>(/*finalize=*/jlcxx::finalize_policy::yes, jlcxx::arg("this"), jlcxx::arg("arg0")    );
    ...
    t.method("X", [](XYPoint const& a)->double { return a.X(); }, jlcxx::arg("this"));
    t.method("X", [](XYPoint const* a)->double { return a->X(); }, jlcxx::arg("this"));
    ...
    t.method("Y", [](XYPoint const& a)->double { return a.Y(); }, jlcxx::arg("this"));
    t.method("Y", [](XYPoint const* a)->double { return a->Y(); }, jlcxx::arg("this"));
  }
