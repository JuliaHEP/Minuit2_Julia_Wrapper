...
struct JlROOT_Minuit2_MinimumParameters: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.constructor<unsigned int, double>(/*finalize=*/jlcxx::finalize_policy::yes);
    ...
    t.constructor<const ROOT::Minuit2::MnAlgebraicVector &, double>(/*finalize=*/jlcxx::finalize_policy::yes);
    ...
    t.constructor<const ROOT::Minuit2::MnAlgebraicVector &, const ROOT::Minuit2::MnAlgebraicVector &, double>(/*finalize=*/jlcxx::finalize_policy::yes);
    ...
    t.method("Vec", static_cast<const ROOT::Minuit2::MnAlgebraicVector & (ROOT::Minuit2::MinimumParameters::*)()  const>(&ROOT::Minuit2::MinimumParameters::Vec));
    ...
    t.method("Dirin", static_cast<const ROOT::Minuit2::MnAlgebraicVector & (ROOT::Minuit2::MinimumParameters::*)()  const>(&ROOT::Minuit2::MinimumParameters::Dirin));
    ...
    t.method("Fval", static_cast<double (ROOT::Minuit2::MinimumParameters::*)()  const>(&ROOT::Minuit2::MinimumParameters::Fval));
    ...
    t.method("IsValid", static_cast<bool (ROOT::Minuit2::MinimumParameters::*)()  const>(&ROOT::Minuit2::MinimumParameters::IsValid));
    ...
    t.method("HasStepSize", static_cast<bool (ROOT::Minuit2::MinimumParameters::*)()  const>(&ROOT::Minuit2::MinimumParameters::HasStepSize));
  }
