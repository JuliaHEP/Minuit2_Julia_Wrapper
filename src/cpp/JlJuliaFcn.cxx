...
struct JlJuliaFcn: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.constructor<fcn_f, double>(/*finalize=*/jlcxx::finalize_policy::yes, jlcxx::arg("this"), jlcxx::arg("func"), jlcxx::arg("errordef")    );


    DEBUG_MSG("Adding wrapper for void JuliaFcn::JuliaFcn(fcn_f, fcn_g, double) (" __HERE__ ")");
    // defined in cpp/Minuit2Wrap.h:22:5
    t.constructor<fcn_f, fcn_g, double>(/*finalize=*/jlcxx::finalize_policy::yes, jlcxx::arg("this"), jlcxx::arg("func"), jlcxx::arg("grad"), jlcxx::arg("errordef")    );


    DEBUG_MSG("Adding wrapper for void JuliaFcn::JuliaFcn(cost_f, void *, double) (" __HERE__ ")");
    // defined in cpp/Minuit2Wrap.h:23:5
    t.constructor<cost_f, void *, double>(/*finalize=*/jlcxx::finalize_policy::yes, jlcxx::arg("this"), jlcxx::arg("func"), jlcxx::arg("obj"), jlcxx::arg("errordef")    );


    DEBUG_MSG("Adding wrapper for void JuliaFcn::JuliaFcn(cost_f, cost_g, void *, double) (" __HERE__ ")");
    // defined in cpp/Minuit2Wrap.h:24:5
    t.constructor<cost_f, cost_g, void *, double>(/*finalize=*/jlcxx::finalize_policy::yes, jlcxx::arg("this"), jlcxx::arg("func"), jlcxx::arg("grad"), jlcxx::arg("obj"), jlcxx::arg("errordef")    );
    ...
    t.method("Up", [](JuliaFcn const& a)->double { return a.Up(); }, jlcxx::arg("this"));
    t.method("Up", [](JuliaFcn const* a)->double { return a->Up(); }, jlcxx::arg("this"));
    ...
    t.method("paren", [](JuliaFcn const& a, const std::vector<double> & arg0)->double { return a.operator()(arg0); }, jlcxx::arg("this"), jlcxx::arg("par"));
    t.method("paren", [](JuliaFcn const* a, const std::vector<double> & arg0)->double { return a->operator()(arg0); }, jlcxx::arg("this"), jlcxx::arg("par"));
    ...
    t.method("Gradient", [](JuliaFcn const& a, const std::vector<double> & arg0)->std::vector<double> { return a.Gradient(arg0); }, jlcxx::arg("this"), jlcxx::arg("par"));
    t.method("Gradient", [](JuliaFcn const* a, const std::vector<double> & arg0)->std::vector<double> { return a->Gradient(arg0); }, jlcxx::arg("this"), jlcxx::arg("par"));
    ...
    t.method("HasGradient", [](JuliaFcn const& a)->bool { return a.HasGradient(); }, jlcxx::arg("this"));
    t.method("HasGradient", [](JuliaFcn const* a)->bool { return a->HasGradient(); }, jlcxx::arg("this"));
    ...
    t.method("SetErrorDef", [](JuliaFcn& a, double arg0)->void { a.SetErrorDef(arg0); }, jlcxx::arg("this"), jlcxx::arg("def"));
    t.method("SetErrorDef", [](JuliaFcn* a, double arg0)->void { a->SetErrorDef(arg0); }, jlcxx::arg("this"), jlcxx::arg("def"));
    ...
    t.method("Nfcn", [](JuliaFcn const& a)->unsigned int { return a.Nfcn(); }, jlcxx::arg("this"));
    t.method("Nfcn", [](JuliaFcn const* a)->unsigned int { return a->Nfcn(); }, jlcxx::arg("this"));
    ...
    t.method("Ngrad", [](JuliaFcn const& a)->unsigned int { return a.Ngrad(); }, jlcxx::arg("this"));
    t.method("Ngrad", [](JuliaFcn const* a)->unsigned int { return a->Ngrad(); }, jlcxx::arg("this"));
  }
