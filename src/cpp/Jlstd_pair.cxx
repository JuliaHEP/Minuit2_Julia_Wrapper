...
struct Jlstd_pair: public Wrapper {
  ...
  Jlstd_pair(jlcxx::Module& jlModule): Wrapper(jlModule){
    ...
    // defined in /Library/Developer/CommandLineTools/SDKs/MacOSX14.sdk/usr/include/c++/v1/__utility/pair.h:81:29
    ...
    auto t13_decl_methods = [this]<typename _T1, typename _T2> (jlcxx::TypeWrapper<std::pair<_T1, _T2>> wrapped){
      auto module_ = this->module_;
    };
    t.apply<std::pair<double, double>>(t13_decl_methods);
  }
