...
struct JlROOT_Minuit2_MnMachinePrecision: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("Eps", [](ROOT::Minuit2::MnMachinePrecision const& a)->double { return a.Eps(); }, jlcxx::arg("this"));
    t.method("Eps", [](ROOT::Minuit2::MnMachinePrecision const* a)->double { return a->Eps(); }, jlcxx::arg("this"));
    ...
    t.method("Eps2", [](ROOT::Minuit2::MnMachinePrecision const& a)->double { return a.Eps2(); }, jlcxx::arg("this"));
    t.method("Eps2", [](ROOT::Minuit2::MnMachinePrecision const* a)->double { return a->Eps2(); }, jlcxx::arg("this"));
    ...
    t.method("SetPrecision", [](ROOT::Minuit2::MnMachinePrecision& a, double arg0)->void { a.SetPrecision(arg0); }, jlcxx::arg("this"), jlcxx::arg("prec"));
    t.method("SetPrecision", [](ROOT::Minuit2::MnMachinePrecision* a, double arg0)->void { a->SetPrecision(arg0); }, jlcxx::arg("this"), jlcxx::arg("prec"));
    ...
    t.method("ComputePrecision", [](ROOT::Minuit2::MnMachinePrecision& a)->void { a.ComputePrecision(); }, jlcxx::arg("this"));
    t.method("ComputePrecision", [](ROOT::Minuit2::MnMachinePrecision* a)->void { a->ComputePrecision(); }, jlcxx::arg("this"));
  }
