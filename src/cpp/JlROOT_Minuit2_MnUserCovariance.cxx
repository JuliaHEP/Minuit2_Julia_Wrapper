...
struct JlROOT_Minuit2_MnUserCovariance: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("paren", [](ROOT::Minuit2::MnUserCovariance const& a, unsigned int arg0, unsigned int arg1)->double { return a.operator()(arg0, arg1); });
    t.method("paren", [](ROOT::Minuit2::MnUserCovariance const* a, unsigned int arg0, unsigned int arg1)->double { return a->operator()(arg0, arg1); });
    ...
    t.method("paren", [](ROOT::Minuit2::MnUserCovariance& a, unsigned int arg0, unsigned int arg1)->double & { return a.operator()(arg0, arg1); });
    t.method("paren", [](ROOT::Minuit2::MnUserCovariance* a, unsigned int arg0, unsigned int arg1)->double & { return a->operator()(arg0, arg1); });
    ...
    t.method("Scale", [](ROOT::Minuit2::MnUserCovariance& a, double arg0)->void { a.Scale(arg0); });
    t.method("Scale", [](ROOT::Minuit2::MnUserCovariance* a, double arg0)->void { a->Scale(arg0); });
    ...
    t.method("Data", [](ROOT::Minuit2::MnUserCovariance const& a)->const std::vector<double> & { return a.Data(); });
    t.method("Data", [](ROOT::Minuit2::MnUserCovariance const* a)->const std::vector<double> & { return a->Data(); });
    ...
    t.method("Nrow", [](ROOT::Minuit2::MnUserCovariance const& a)->unsigned int { return a.Nrow(); });
    t.method("Nrow", [](ROOT::Minuit2::MnUserCovariance const* a)->unsigned int { return a->Nrow(); });
    ...
    t.method("size", [](ROOT::Minuit2::MnUserCovariance const& a)->unsigned int { return a.size(); });
    t.method("size", [](ROOT::Minuit2::MnUserCovariance const* a)->unsigned int { return a->size(); });
  }
