...
struct JlROOT_Minuit2_MnGlobalCorrelationCoeff: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("GlobalCC", [](ROOT::Minuit2::MnGlobalCorrelationCoeff const& a)->const std::vector<double> & { return a.GlobalCC(); });
    t.method("GlobalCC", [](ROOT::Minuit2::MnGlobalCorrelationCoeff const* a)->const std::vector<double> & { return a->GlobalCC(); });
    ...
    t.method("IsValid", [](ROOT::Minuit2::MnGlobalCorrelationCoeff const& a)->bool { return a.IsValid(); });
    t.method("IsValid", [](ROOT::Minuit2::MnGlobalCorrelationCoeff const* a)->bool { return a->IsValid(); });
  }
